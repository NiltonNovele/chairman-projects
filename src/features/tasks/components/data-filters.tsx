    ...
    <div className="flex flex-col lg:flex-row gap-2">
      ...
      >
        ...
        <SelectContent>
          ...
          <SelectSeparator />
          <SelectItem value={TaskStatus.BACKLOG}>Pendências</SelectItem>
          <SelectItem value={TaskStatus.IN_PROGRESS}>Em curso</SelectItem>
          <SelectItem value={TaskStatus.IN_REVIEW}>Em revisão</SelectItem>
          <SelectItem value={TaskStatus.TODO}>Por fazer</SelectItem>
