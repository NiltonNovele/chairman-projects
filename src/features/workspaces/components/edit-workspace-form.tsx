                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          {...field}
                          placeholder="Introduza o nome do espaço de trabalho"
                        />
                      </FormControl>
                    </FormItem>
                  )}
      ...
      <Card className="w-full h-full border-none shadow-none">
        <CardContent className="p-7">
          <div className="flex flex-col">
            ...
            <p className="text-sm text-muted-foreground">
              Utilize o link de convite para adicionar membros ao seu espaço de
              trabalho.
            </p>
      ...
      <Card className="w-full h-full border-none shadow-none">
        <CardContent className="p-7">
          <div className="flex flex-col">
            ...
            <p className="text-sm text-muted-foreground">
              A eliminação de um espaço de trabalho é irreversível e removerá
